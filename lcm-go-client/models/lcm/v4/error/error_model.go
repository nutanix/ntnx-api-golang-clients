/*
 * Generated file models/lcm/v4/error/error_model.go.
 *
...
func NewAppMessage() *AppMessage {
  ...
  *p.ObjectType_ = "lcm.v4.error.AppMessage"
  p.Reserved_ = map[string]interface{}{"$fqObjectType": "lcm.v4.r0.a1.error.AppMessage"}
...
func NewErrorResponse() *ErrorResponse {
  p := new(ErrorResponse)
  p.ObjectType_ = new(string)
  *p.ObjectType_ = "lcm.v4.error.ErrorResponse"
  p.Reserved_ = map[string]interface{}{"$fqObjectType": "lcm.v4.r0.a1.error.ErrorResponse"}
  p.UnknownFields_ = map[string]interface{}{}
...
func NewSchemaValidationError() *SchemaValidationError {
  ...
  p.ObjectType_ = new(string)
  *p.ObjectType_ = "lcm.v4.error.SchemaValidationError"
  p.Reserved_ = map[string]interface{}{"$fqObjectType": "lcm.v4.r0.a1.error.SchemaValidationError"}
  p.UnknownFields_ = map[string]interface{}{}
...
func NewSchemaValidationErrorMessage() *SchemaValidationErrorMessage {
  ...
  p.ObjectType_ = new(string)
  *p.ObjectType_ = "lcm.v4.error.SchemaValidationErrorMessage"
  p.Reserved_ = map[string]interface{}{"$fqObjectType": "lcm.v4.r0.a1.error.SchemaValidationErrorMessage"}
  p.UnknownFields_ = map[string]interface{}{}
...
func (p *OneOfErrorResponseError) SetValue (v interface {}) error {
  ...
  switch v.(type) {
    case []AppMessage:
      ...
      *p.Discriminator = "List<lcm.v4.error.AppMessage>"
      if nil == p.ObjectType_ {p.ObjectType_ = new(string)}
      *p.ObjectType_ = "List<lcm.v4.error.AppMessage>"
...
func (p *OneOfErrorResponseError) GetValue() interface{} {
  if "List<lcm.v4.error.AppMessage>" == *p.Discriminator {
...
func (p *OneOfErrorResponseError) UnmarshalJSON(b []byte) error {
  ...
  if err := json.Unmarshal(b, vOneOfType201); err == nil {
    if len(*vOneOfType201) == 0 || "lcm.v4.error.AppMessage" == *((*vOneOfType201)[0].ObjectType_) {
  ...
  if err := json.Unmarshal(b, vOneOfType202); err == nil {
    if "lcm.v4.error.SchemaValidationError" == *vOneOfType202.ObjectType_ {
          if nil == p.oneOfType202 {p.oneOfType202 = new(SchemaValidationError)}
