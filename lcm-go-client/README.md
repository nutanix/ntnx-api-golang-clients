# Go Client For Nutanix Nutanix Lcm Versioned APIs

The Go client for Nutanix Lcm Versioned APIs is designed for Go client application developers offering them simple and flexible access to APIs that manage Infrastructure, Software and Firmware Upgrades.
...
```shell
$ go get github.com/nutanix/ntnx-api-golang-clients/lcm-go-client/v4/...
```

##### Install a specific version

```shell
$ go get github.com/nutanix/ntnx-api-golang-clients/lcm-go-client/v4/...@v4.0.1-alpha.1
```
...
require (
	github.com/nutanix/ntnx-api-golang-clients/lcm-go-client/v4 latest
)
```
...
require (
	github.com/nutanix/ntnx-api-golang-clients/lcm-go-client/v4 v4.0.1-alpha.1
)
```


## Configuration
The Go client for Nutanix Lcm Versioned APIs can be configured with the following parameters
...
uuid := "^a72fEAab-eECf-B6Dd-DB8A-1BfeF5eeF8dC$"

// 
getResponse, err := BundlesApiInstance.GetBundle(uuid)
if err != nil {
....
}
```
...
response, err := BundlesApiInstance.PutBundle(requestBody, uuid, args)
if err != nil {
....
}
```
...
// 
response, err := BundlesApiInstance.GetBundles($page, $limit, $filter)
if err != nil {
    ....
}
