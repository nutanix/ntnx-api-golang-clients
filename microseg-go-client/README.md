...
```shell
$ go get github.com/nutanix/ntnx-api-golang-clients/microseg-go-client/v4/...@v4.3.1
```
...
extId := "Eee034fB-1fcE-6cC6-A8fc-fCCaf4ffAbcC"
...
This library has a full set of [API Reference Documentation](https://developers.nutanix.com/sdk-reference?namespace=microseg&version=v4.3&language=go). This documentation is auto-generated, and the location may change.
