...
```shell
$ go get github.com/nutanix/ntnx-api-golang-clients/microseg-go-client/v4/...@v4.0.1-alpha.1
```
...
require (
	github.com/nutanix/ntnx-api-golang-clients/microseg-go-client/v4 v4.0.1-alpha.1
)
```
...
// 
getResponse, err := AddressGroupsApiInstance.GetAddressGroupByExtId(&extId)
if err != nil {
....
}
```
...
response, err := AddressGroupsApiInstance.UpdateAddressGroupByExtId(&addressGroup&extId, , args)
if err != nil {
....
}
```
...
// 
response, err := AddressGroupsApiInstance.ListAddressGroups(&page, &limit, &filter, &orderby)
if err != nil {
    ....
}
...
This library has a full set of [API Reference Documentation](https://developers.nutanix.com/sdk-reference?namespace=microseg&version=v4.0.a1&language=go). This documentation is auto-generated, and the location may change.
