# Go Client For Nutanix Flow Management APIs

The Go client for Nutanix Flow Management APIs is designed for Go client application developers offering them simple and flexible access to APIs that manage Network Security Policy configuration of Nutanix clusters.
...
```shell
$ go get github.com/nutanix/ntnx-api-golang-clients/microseg-go-client/v4/...
```

##### Install a specific version

```shell
$ go get github.com/nutanix/ntnx-api-golang-clients/microseg-go-client/v4/...@v4.2.1
```
...
require (
	github.com/nutanix/ntnx-api-golang-clients/microseg-go-client/v4 latest
)
```
...
## Configuration
The Go client for Nutanix Flow Management APIs can be configured with the following parameters
...
extId := "9f8fdCEC-6cad-590f-cbEa-dd3De42799Ae"
...
This library has a full set of [API Reference Documentation](https://developers.nutanix.com/sdk-reference?namespace=microseg&version=v4.2&language=go). This documentation is auto-generated, and the location may change.
