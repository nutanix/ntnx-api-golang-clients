...
/*
Specifies the IP version for this FLEX rule.
*/
type IPAddressScope int

const (
	IPADDRESSSCOPE_UNKNOWN   IPAddressScope = 0
	IPADDRESSSCOPE_REDACTED  IPAddressScope = 1
	IPADDRESSSCOPE_IPV4      IPAddressScope = 2
	IPADDRESSSCOPE_IPV6      IPAddressScope = 3
	IPADDRESSSCOPE_IPV4_IPV6 IPAddressScope = 4
)

// Returns the name of the enum given an ordinal number
//
// Deprecated: Please use GetName instead of name
func (e *IPAddressScope) name(index int) string {
	names := [...]string{
		"$UNKNOWN",
		"$REDACTED",
		"IPV4",
...
func (e IPAddressScope) GetName() string {
	index := int(e)
	names := [...]string{
		"$UNKNOWN",
		"$REDACTED",
...
func (e *IPAddressScope) index(name string) IPAddressScope {
	names := [...]string{
		"$UNKNOWN",
		"$REDACTED",
		"IPV4",
	...
	for idx := range names {
		if names[idx] == name {
			return IPAddressScope(idx)
		}
	}
	return IPADDRESSSCOPE_UNKNOWN
}

func (e *IPAddressScope) UnmarshalJSON(b []byte) error {
	var enumStr string
	if err := json.Unmarshal(b, &enumStr); err != nil {
		return errors.New(fmt.Sprintf("Unable to unmarshal for IPAddressScope:%s", err))
	}
	*e = e.index(enumStr)
	return nil
}

func (e *IPAddressScope) MarshalJSON() ([]byte, error) {
...
func (e IPAddressScope) Ref() *IPAddressScope {
	return &e
}
