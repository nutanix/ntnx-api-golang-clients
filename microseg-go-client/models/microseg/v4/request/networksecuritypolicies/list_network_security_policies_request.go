...
// This file holds the request struct for the ListNetworkSecurityPolicies operation.

type ListNetworkSecurityPoliciesRequest struct {
	// The header parameter specifies the project external identifier to filter policies for export. Only applicable when
	// downloading policies as a binary file (application/octet-stream).
	NTNXProjectExtId *string
