...
// This file holds the request struct for the ListContentRepositoryItemsByContentRepositoryId operation.

type ListContentRepositoryItemsByContentRepositoryIdRequest struct {
	// (required) The external identifier of a Content Repository.
	ExtId *string

	// The external identifier of a Domain Manager or Prism Central.
	XClusterId *string
