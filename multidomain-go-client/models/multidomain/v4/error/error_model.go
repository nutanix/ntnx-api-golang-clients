/*
 * Generated file models/multidomain/v4/error/error_model.go.
 *
...
func NewAppMessage() *AppMessage {
	...
	*p.ObjectType_ = "multidomain.v4.error.AppMessage"
...
func NewErrorResponse() *ErrorResponse {
	p := new(ErrorResponse)
	p.ObjectType_ = new(string)
	*p.ObjectType_ = "multidomain.v4.error.ErrorResponse"
	p.Reserved_ = map[string]interface{}{"$fv": "v4.r4.b1"}
	p.UnknownFields_ = map[string]interface{}{}
...
func NewSchemaValidationError() *SchemaValidationError {
	...
	p.ObjectType_ = new(string)
	*p.ObjectType_ = "multidomain.v4.error.SchemaValidationError"
	p.Reserved_ = map[string]interface{}{"$fv": "v4.r4.b1"}
	p.UnknownFields_ = map[string]interface{}{}
...
func NewSchemaValidationErrorMessage() *SchemaValidationErrorMessage {
	...
	p.ObjectType_ = new(string)
	*p.ObjectType_ = "multidomain.v4.error.SchemaValidationErrorMessage"
	p.Reserved_ = map[string]interface{}{"$fv": "v4.r4.b1"}
	p.UnknownFields_ = map[string]interface{}{}
...
func (p *OneOfErrorResponseError) SetValue(v interface{}) error {
	...
	case []AppMessage:
		...
		*p.Discriminator = "List<multidomain.v4.error.AppMessage>"
		if nil == p.ObjectType_ {
			p.ObjectType_ = new(string)
		}
		*p.ObjectType_ = "List<multidomain.v4.error.AppMessage>"
	default:
...
func (p *OneOfErrorResponseError) GetValue() interface{} {
	...
	if "List<multidomain.v4.error.AppMessage>" == *p.Discriminator {
...
func (p *OneOfErrorResponseError) UnmarshalJSON(b []byte) error {
	...
	if err := json.Unmarshal(b, &rawMap); err == nil {
			...
			if valueData, ok := nestedMap["value"]; ok {
				...
				if marshalErr == nil {
					...
					if unmarshalErr == nil {
						...
						if vOneOfType202.ObjectType_ != nil && "multidomain.v4.error.SchemaValidationError" == *vOneOfType202.ObjectType_ {
							if nil == p.oneOfType202 {
								p.oneOfType202 = new(SchemaValidationError)
							}
		...
		// Check if this field name exists in the map (handles nested structure)
		if nestedMap, ok := rawMap["List<multidomain.v4.error.AppMessage>"].(map[string]interface{}); ok {
			// Check for "value" wrapper
			if valueData, ok := nestedMap["value"]; ok {
				valueJSON, marshalErr := json.Marshal(valueData)
				if marshalErr == nil {
					...
					if unmarshalErr == nil {
						...
						if vOneOfType201 == nil || len(*vOneOfType201) == 0 || ((*vOneOfType201)[0].ObjectType_ != nil && "multidomain.v4.error.AppMessage" == *((*vOneOfType201)[0].ObjectType_)) {
	...
	if err := json.Unmarshal(b, vOneOfType201); err == nil {
		if len(*vOneOfType201) == 0 || (vOneOfType201 != nil && (*vOneOfType201)[0].ObjectType_ != nil && "multidomain.v4.error.AppMessage" == *((*vOneOfType201)[0].ObjectType_)) {
			p.oneOfType201 = *vOneOfType201
			if nil == p.Discriminator {
				p.Discriminator = new(string)
			}
