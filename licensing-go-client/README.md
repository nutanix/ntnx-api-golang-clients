...
```shell
$ go get github.com/nutanix/ntnx-api-golang-clients/licensing-go-client/v4/...
```

##### Install a specific version

```shell
$ go get github.com/nutanix/ntnx-api-golang-clients/licensing-go-client/v4/...@v4.4.1
```
...
require (
	github.com/nutanix/ntnx-api-golang-clients/licensing-go-client/v4 latest
)
```
...
require (
	github.com/nutanix/ntnx-api-golang-clients/licensing-go-client/v4 v4.4.1
)
```


## Configuration
The Go client for Nutanix Licensing APIs can be configured with the following parameters
...
extId := "aD37DB1B-18Ec-8EBe-febA-CEeCfd2fEFea"

// 
getResponse, err := LicensesApiInstance.GetSettingById(&extId)
if err != nil {
....
}
```
...
// Initialize the API
LicenseKeysApiInstance = api.NewLicenseKeysApi(ApiClientInstance)
page_ := 0
limit_ := 50
...
// 
response, err := LicenseKeysApiInstance.ListLicenseKeys(&page_, &limit_, &filter_, &orderby_, &expand_, &select_)
if err != nil {
    ....
}
...
This library has a full set of [API Reference Documentation](https://developers.nutanix.com/sdk-reference?namespace=licensing&version=v4.4&language=go). This documentation is auto-generated, and the location may change.
