...
```shell
$ go get github.com/nutanix/ntnx-api-golang-clients/licensing-go-client/v4/...@v4.0.1-alpha.1
```
...
require (
	github.com/nutanix/ntnx-api-golang-clients/licensing-go-client/v4 v4.0.1-alpha.1
)
```
