...
```shell
$ go get github.com/nutanix/ntnx-api-golang-clients/licensing-go-client/v4/...@v4.0.1
```
...
require (
	github.com/nutanix/ntnx-api-golang-clients/licensing-go-client/v4 v4.0.1
)
```
...
This library has a full set of [API Reference Documentation](https://developers.nutanix.com/sdk-reference?namespace=licensing&version=v4.0&language=go). This documentation is auto-generated, and the location may change.
