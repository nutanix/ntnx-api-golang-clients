...
```shell
$ go get github.com/nutanix/ntnx-api-golang-clients/monitoring-go-client/v4/...@v4.0.1-beta.1
```
...
require (
	github.com/nutanix/ntnx-api-golang-clients/monitoring-go-client/v4 v4.0.1-beta.1
)
```
