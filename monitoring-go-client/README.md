...
```shell
$ go get github.com/nutanix/ntnx-api-golang-clients/monitoring-go-client/v4/...@v4.0.1
```
...
require (
	github.com/nutanix/ntnx-api-golang-clients/monitoring-go-client/v4 v4.0.1
)
```
...
extId := "1be7fD5D-6a14-a0ba-DEFC-CEc5DF83BB1F"
...
This library has a full set of [API Reference Documentation](https://developers.nutanix.com/sdk-reference?namespace=monitoring&version=v4.0&language=go). This documentation is auto-generated, and the location may change.
