...
```shell
$ go get github.com/nutanix/ntnx-api-golang-clients/monitoring-go-client/v4/...@v4.1.1
```
...
require (
	github.com/nutanix/ntnx-api-golang-clients/monitoring-go-client/v4 v4.1.1
)
```
...
systemDefinedPolicyExtId := "0"
extId := "56FEAbaD-DaBa-CD4E-33DC-dF6CaAa5ddD2"
...
This library has a full set of [API Reference Documentation](https://developers.nutanix.com/sdk-reference?namespace=monitoring&version=v4.1&language=go). This documentation is auto-generated, and the location may change.
