# Go Client For Nutanix Cluster Management APIs
...
var (
	ApiClientInstance *client.ApiClient
	CertificateManagerApiInstance *api.CertificateManagerApi
)
...
// 
response, err := CertificateManagerApiInstance.ListCertificatesByClusterId(&clusterExtId, &page_, &limit_, &filter_, &orderby_, &select_)
if err != nil {
    ....
}
...
This library has a full set of [API Reference Documentation](https://developers.nutanix.com/sdk-reference?namespace=clustermgmt&version=v4.3&language=go). This documentation is auto-generated, and the location may change.
