...
// This file holds the request struct for the ListDataStoresByClusterId operation.

type ListDataStoresByClusterIdRequest struct {
	// (required) The cluster from which the datastores needs to be listed.
	ClusterExtId *string
