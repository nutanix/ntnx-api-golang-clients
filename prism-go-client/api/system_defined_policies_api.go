...
func (api *SystemDefinedPoliciesApi) GetSdaPolicies(page_ *int, limit_ *int, filter_ *string, orderby_ *string, args ...map[string]interface{}) (*import1.ListSdaPoliciesApiResponse, error) {
	argMap := make(map[string]interface{})
	if len(args) > 0 {
		argMap = args[0]
	}

	uri := "/api/prism/v4.0.a2/serviceability/alerts/system-defined-policies"
...
func (api *SystemDefinedPoliciesApi) GetSdaPolicyById(extId *string, args ...map[string]interface{}) (*import1.GetSdaPolicyApiResponse, error) {
	...
	uri := "/api/prism/v4.0.a2/serviceability/alerts/system-defined-policies/{extId}"
...
func (api *SystemDefinedPoliciesApi) UpdateSdaPolicy(extId *string, body *import1.SystemDefinedPolicy, args ...map[string]interface{}) (*import1.UpdateSdaPolicyApiResponse, error) {
	argMap := make(map[string]interface{})
	if len(args) > 0 {
		argMap = args[0]
	}
	...
	unmarshalledResp := new(import1.UpdateSdaPolicyApiResponse)
	json.Unmarshal(responseBody, &unmarshalledResp)
	return unmarshalledResp, err
}
