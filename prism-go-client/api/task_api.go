...
*/
func (api *TaskApi) TaskCancel(taskExtId *string, args ...map[string]interface{}) (*import3.TaskCancelResponse, error) {
	...
	unmarshalledResp := new(import3.TaskCancelResponse)
...
*/
func (api *TaskApi) TaskGet(taskExtId *string, args ...map[string]interface{}) (*import3.TaskGetResponse, error) {
	argMap := make(map[string]interface{})
	if len(args) > 0 {
		argMap = args[0]
	}
	...
	unmarshalledResp := new(import3.TaskGetResponse)
	json.Unmarshal(responseBody, &unmarshalledResp)
	return unmarshalledResp, err
}
