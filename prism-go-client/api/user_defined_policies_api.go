...
*/
func (api *UserDefinedPoliciesApi) CreateUdaPolicy(body *import5.UserDefined, args ...map[string]interface{}) (*import5.CreateUdaPolicyApiResponse, error) {
	...
	unmarshalledResp := new(import5.CreateUdaPolicyApiResponse)
...
*/
func (api *UserDefinedPoliciesApi) DeleteUdaPolicy(extId *string, args ...map[string]interface{}) (*import5.DeleteUdaPolicyApiResponse, error) {
	argMap := make(map[string]interface{})
	if len(args) > 0 {
		argMap = args[0]
	}
	...
	unmarshalledResp := new(import5.DeleteUdaPolicyApiResponse)
	json.Unmarshal(responseBody, &unmarshalledResp)
	return unmarshalledResp, err
}
...
*/
func (api *UserDefinedPoliciesApi) FindConflictingUdaPolicies(body *import5.UserDefined, args ...map[string]interface{}) (*import5.ListConflictingUdaPoliciesApiResponse, error) {
	argMap := make(map[string]interface{})
	if len(args) > 0 {
		argMap = args[0]
	}
	...
	unmarshalledResp := new(import5.ListConflictingUdaPoliciesApiResponse)
	json.Unmarshal(responseBody, &unmarshalledResp)
	return unmarshalledResp, err
}
...
*/
func (api *UserDefinedPoliciesApi) GetUdaPolicies(page_ *int, limit_ *int, filter_ *string, orderby_ *string, args ...map[string]interface{}) (*import5.ListUdaPoliciesApiResponse, error) {
	argMap := make(map[string]interface{})
	if len(args) > 0 {
		argMap = args[0]
	}
	...
	unmarshalledResp := new(import5.ListUdaPoliciesApiResponse)
	json.Unmarshal(responseBody, &unmarshalledResp)
	return unmarshalledResp, err
}
...
*/
func (api *UserDefinedPoliciesApi) GetUdaPolicyById(extId *string, args ...map[string]interface{}) (*import5.GetUdaPolicyApiResponse, error) {
	argMap := make(map[string]interface{})
	if len(args) > 0 {
		argMap = args[0]
	}
	...
	unmarshalledResp := new(import5.GetUdaPolicyApiResponse)
	json.Unmarshal(responseBody, &unmarshalledResp)
	return unmarshalledResp, err
}
...
*/
func (api *UserDefinedPoliciesApi) UpdateUdaPolicy(body *import5.UserDefined, extId *string, args ...map[string]interface{}) (*import5.UpdateUdaPolicyApiResponse, error) {
	argMap := make(map[string]interface{})
	if len(args) > 0 {
		argMap = args[0]
	}
	...
	unmarshalledResp := new(import5.UpdateUdaPolicyApiResponse)
	json.Unmarshal(responseBody, &unmarshalledResp)
	return unmarshalledResp, err
}
