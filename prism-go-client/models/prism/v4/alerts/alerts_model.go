...
type AlertDb struct {
  ...
  */
  ...
  SourceEntity *AlertEntityReference `json:"sourceEntity,omitempty"`
  /**
  A globally unique identifier that represents the tenant that owns this entity.  It is automatically assigned by the system and is immutable from an API consumer perspective (some use cases may cause this Id to change - for instance a use case may require the transfer of ownership of the entity, but these cases are handled automatically on the server).
  */
  TenantId *string `json:"tenantId,omitempty"`
...
func NewAlertEntityReference() *AlertEntityReference {
  ...
  p.ObjectType_ = new(string)
  *p.ObjectType_ = "prism.v4.alerts.AlertEntityReference"
  p.Reserved_ = map[string]interface{}{"$fqObjectType": "prism.v4.r0.a1.alerts.AlertEntityReference"}
  p.UnknownFields_ = map[string]interface{}{}
...
func (p *OneOfAlertApiResponseData) SetValue (v interface {}) error {
  ...
  switch v.(type) {
    case Alert:
      if nil == p.oneOfType0 {p.oneOfType0 = new(Alert)}
