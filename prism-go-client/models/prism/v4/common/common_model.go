...
/*
  Common Utilities for Tasks and Monitoring
*/
package common
import (
  "bytes"
...
func (p *OneOfMetricDetailMetricValue) SetValue (v interface {}) error {
  ...
  switch v.(type) {
    case BoolValue:
      if nil == p.oneOfType1 {p.oneOfType1 = new(BoolValue)}
    ...
    case DoubleValue:
      if nil == p.oneOfType2 {p.oneOfType2 = new(DoubleValue)}
    ...
    case StringValue:
      if nil == p.oneOfType0 {p.oneOfType0 = new(StringValue)}
    ...
    case IntValue:
      if nil == p.oneOfType3 {p.oneOfType3 = new(IntValue)}
...
func (p *OneOfMetricDetailMetricValue) UnmarshalJSON(b []byte) error {
  ...
  if err := json.Unmarshal(b, vOneOfType1); err == nil {
    if "prism.v4.common.BoolValue" == *vOneOfType1.ObjectType_ {
          if nil == p.oneOfType1 {p.oneOfType1 = new(BoolValue)}
  ...
  if err := json.Unmarshal(b, vOneOfType2); err == nil {
    if "prism.v4.common.DoubleValue" == *vOneOfType2.ObjectType_ {
          if nil == p.oneOfType2 {p.oneOfType2 = new(DoubleValue)}
  ...
  if err := json.Unmarshal(b, vOneOfType0); err == nil {
    if "prism.v4.common.StringValue" == *vOneOfType0.ObjectType_ {
          if nil == p.oneOfType0 {p.oneOfType0 = new(StringValue)}
  ...
  if err := json.Unmarshal(b, vOneOfType3); err == nil {
    if "prism.v4.common.IntValue" == *vOneOfType3.ObjectType_ {
          if nil == p.oneOfType3 {p.oneOfType3 = new(IntValue)}
...
func (p *OneOfParameterParamValue) SetValue (v interface {}) error {
  ...
  switch v.(type) {
    case BoolValue:
      ...
      *p.ObjectType_ = *p.oneOfType1.ObjectType_
    case IntValue:
      if nil == p.oneOfType2 {p.oneOfType2 = new(IntValue)}
...
func (p *OneOfParameterParamValue) UnmarshalJSON(b []byte) error {
  ...
  if err := json.Unmarshal(b, vOneOfType2); err == nil {
    if "prism.v4.common.IntValue" == *vOneOfType2.ObjectType_ {
          if nil == p.oneOfType2 {p.oneOfType2 = new(IntValue)}
      *p.oneOfType2 = *vOneOfType2
      if nil == p.Discriminator {p.Discriminator = new(string)}
      *p.Discriminator = *p.oneOfType2.ObjectType_
