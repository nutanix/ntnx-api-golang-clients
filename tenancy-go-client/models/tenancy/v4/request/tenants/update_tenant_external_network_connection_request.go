...
// This file holds the request struct for the UpdateTenantExternalNetworkConnection operation.

type UpdateTenantExternalNetworkConnectionRequest struct {
	...
	// (required)
	Body *import1.ExternalNetworkConnConfig
}
