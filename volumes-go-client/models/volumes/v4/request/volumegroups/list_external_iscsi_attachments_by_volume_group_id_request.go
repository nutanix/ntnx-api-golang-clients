...
// This file holds the request struct for the ListExternalIscsiAttachmentsByVolumeGroupId operation.

//
// Deprecated: The API corresponding to this struct has been deprecated.
type ListExternalIscsiAttachmentsByVolumeGroupIdRequest struct {
