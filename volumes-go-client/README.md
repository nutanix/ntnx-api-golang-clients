...
```shell
$ go get github.com/nutanix/ntnx-api-golang-clients/volumes-go-client/v4/...@v4.1.1
```
...
extId := "a8de0E7a-03F3-6BbD-db7f-D8aa3CBca0F8"
...
This library has a full set of [API Reference Documentation](https://developers.nutanix.com/sdk-reference?namespace=volumes&version=v4.1&language=go). This documentation is auto-generated, and the location may change.
