...
```shell
$ go get github.com/nutanix/ntnx-api-golang-clients/volumes-go-client/v4/...@v4.2.1
```
...
extId := "b3adA42C-EC3F-eF19-07bA-7DBED3b1Ba0d"
...
This library has a full set of [API Reference Documentation](https://developers.nutanix.com/sdk-reference?namespace=volumes&version=v4.2&language=go). This documentation is auto-generated, and the location may change.
