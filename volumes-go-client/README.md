...
```shell
$ go get github.com/nutanix/ntnx-api-golang-clients/volumes-go-client/v4/...@v4.3.1
```
...
extId := "7Cc91dea-eCf3-bE97-AAeB-C4fded9A6a88"
...
This library has a full set of [API Reference Documentation](https://developers.nutanix.com/sdk-reference?namespace=volumes&version=v4.3&language=go). This documentation is auto-generated, and the location may change.
