# Go Client For Nutanix Volumes APIs

The Go client for Nutanix Volumes APIs is designed for Go client application developers offering them simple and flexible access to APIs that configure volumes.
...
```shell
$ go get github.com/nutanix/ntnx-api-golang-clients/volumes-go-client/v4/...
```

##### Install a specific version

```shell
$ go get github.com/nutanix/ntnx-api-golang-clients/volumes-go-client/v4/...@v4.0.1
```
...
require (
	github.com/nutanix/ntnx-api-golang-clients/volumes-go-client/v4 latest
)
```
...
## Configuration
The Go client for Nutanix Volumes APIs can be configured with the following parameters
...
extId := "D9Bc872a-6b1D-BaEd-dc0a-3FBBAfaF9Ef0"
...
// ...
iscsiClient := getResponse.GetData().(import1.IscsiClient)

// The body parameter in the following operation is received from the previous GET request's response which needs to be updated.
response, err := IscsiClientsApiInstance.UpdateIscsiClientById(&iscsiClient&extId, , args)
if err != nil {
....
}
```
...
This library has a full set of [API Reference Documentation](https://developers.nutanix.com/sdk-reference?namespace=volumes&version=v4.0&language=go). This documentation is auto-generated, and the location may change.
