...
func NewAppMessage() *AppMessage {
	...
	*p.ObjectType_ = "vmm.v4.error.AppMessage"
	p.Reserved_ = map[string]interface{}{"$fqObjectType": "vmm.v4.r0.a1.error.AppMessage"}
...
func NewErrorResponse() *ErrorResponse {
	...
	*p.ObjectType_ = "vmm.v4.error.ErrorResponse"
	p.Reserved_ = map[string]interface{}{"$fqObjectType": "vmm.v4.r0.a1.error.ErrorResponse"}
	p.UnknownFields_ = map[string]interface{}{}
...
func NewSchemaValidationError() *SchemaValidationError {
	...
	*p.ObjectType_ = "vmm.v4.error.SchemaValidationError"
	p.Reserved_ = map[string]interface{}{"$fqObjectType": "vmm.v4.r0.a1.error.SchemaValidationError"}
	p.UnknownFields_ = map[string]interface{}{}
...
func NewSchemaValidationErrorMessage() *SchemaValidationErrorMessage {
	...
	*p.ObjectType_ = "vmm.v4.error.SchemaValidationErrorMessage"
	p.Reserved_ = map[string]interface{}{"$fqObjectType": "vmm.v4.r0.a1.error.SchemaValidationErrorMessage"}
	p.UnknownFields_ = map[string]interface{}{}
