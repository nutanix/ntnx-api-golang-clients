...
// This file holds the request struct for the GetVmStatsById operation.

type GetVmStatsByIdRequest struct {
	// (required) Retrieve statistics for the VM with the specified external ID.
	ExtId *string
