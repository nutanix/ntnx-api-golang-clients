...
// This file holds the request struct for the GetDiskStatsById operation.

type GetDiskStatsByIdRequest struct {
	// (required) This field specifies the VM external ID when retrieving the stats for a given VM Disk.
	VmExtId *string
