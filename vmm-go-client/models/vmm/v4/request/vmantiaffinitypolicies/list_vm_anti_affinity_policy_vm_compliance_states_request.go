...
// This file holds the request struct for the ListVmAntiAffinityPolicyVmComplianceStates operation.

type ListVmAntiAffinityPolicyVmComplianceStatesRequest struct {
	// (required) A globally unique identifier of a VM-VM anti-affinity policy of type UUID.
	VmAntiAffinityPolicyExtId *string
