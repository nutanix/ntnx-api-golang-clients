...
// This file holds the request struct for the ListVmHostAffinityPolicyVmComplianceStates operation.

type ListVmHostAffinityPolicyVmComplianceStatesRequest struct {
	// (required) The external ID (UUID) of the VM-host affinity policy.
	VmHostAffinityPolicyExtId *string
