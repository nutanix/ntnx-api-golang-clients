...
// This file holds the request struct for the TransferFilesToGuest operation.

type TransferFilesToGuestRequest struct {
	// (required) A globally unique identifier of a VM of type UUID.
	ExtId *string

	// (required)
	Body *import21.TransferFilesToGuestSpec
}
