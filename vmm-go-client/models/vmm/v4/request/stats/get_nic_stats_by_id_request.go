...
// This file holds the request struct for the GetNicStatsById operation.

type GetNicStatsByIdRequest struct {
	// (required) This field specifies the VM external ID when retrieving the stats for a given VM NIC.
	VmExtId *string

	// (required) This field specifies the external ID of the VM NIC when retrieving stats for a given VM NIC.
	ExtId *string
