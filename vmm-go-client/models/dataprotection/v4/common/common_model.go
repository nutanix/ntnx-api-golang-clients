...
func NewRecoveryPointProperties() *RecoveryPointProperties {
	...
	*p.ObjectType_ = "dataprotection.v4.common.RecoveryPointProperties"
	p.Reserved_ = map[string]interface{}{"$fqObjectType": "dataprotection.v4.r0.a2.common.RecoveryPointProperties"}
