...
/*
  Module dataprotection.v4.config of Nutanix Vmm Versioned APIs
*/
package config
...
func NewRecoveryPointProperties() *RecoveryPointProperties {
	p := new(RecoveryPointProperties)
	p.ObjectType_ = new(string)
	*p.ObjectType_ = "dataprotection.v4.config.RecoveryPointProperties"
	p.Reserved_ = map[string]interface{}{"$fqObjectType": "dataprotection.v4.r0.a2.config.RecoveryPointProperties"}
...
func NewVendorSpecificProperty() *VendorSpecificProperty {
	...
	p.ObjectType_ = new(string)
	*p.ObjectType_ = "dataprotection.v4.config.VendorSpecificProperty"
	p.Reserved_ = map[string]interface{}{"$fqObjectType": "dataprotection.v4.r0.a2.config.VendorSpecificProperty"}
	p.UnknownFields_ = map[string]interface{}{}
