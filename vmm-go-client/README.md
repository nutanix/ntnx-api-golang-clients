...
```shell
$ go get github.com/nutanix/ntnx-api-golang-clients/vmm-go-client/v4/...@v4.3.1
```
...
extId := "4bDee0CD-43a8-7Cb8-Cf27-4dfCbEcF4B3f"
...
This library has a full set of [API Reference Documentation](https://developers.nutanix.com/sdk-reference?namespace=vmm&version=v4.3&language=go). This documentation is auto-generated, and the location may change.
