# Go Client For Nutanix Virtual Machine Management APIs

The Go client for Nutanix Virtual Machine Management APIs is designed for Go client application developers offering them simple and flexible access to APIs that manage the life-cycle of virtual machines hosted on Nutanix.
...
```shell
$ go get github.com/nutanix/ntnx-api-golang-clients/vmm-go-client/v4/...@v4.0.1
```
...
## Configuration
The Go client for Nutanix Virtual Machine Management APIs can be configured with the following parameters
...
extId := "7bab8Baf-DaAc-51d7-b0CD-ebCdEBA9c0F2"
...
This library has a full set of [API Reference Documentation](https://developers.nutanix.com/sdk-reference?namespace=vmm&version=v4.0&language=go). This documentation is auto-generated, and the location may change.
