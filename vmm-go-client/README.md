...
```shell
$ go get github.com/nutanix/ntnx-api-golang-clients/vmm-go-client/v4/...@v4.2.2
```
...
extId := "3fFC7bbf-3d9b-dB8d-ba50-C6cf30bCdDAc"
...
This library has a full set of [API Reference Documentation](https://developers.nutanix.com/sdk-reference?namespace=vmm&version=v4.2&language=go). This documentation is auto-generated, and the location may change.
