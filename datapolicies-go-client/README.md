# Go Client For Nutanix Data Policies APIs

The Go client for Nutanix Data Policies APIs is designed for Go client application developers offering them simple and flexible access to APIs that manage Policies for Disaster Recovery and Storage.
...
```shell
$ go get github.com/nutanix/ntnx-api-golang-clients/datapolicies-go-client/v4/...
```

##### Install a specific version

```shell
$ go get github.com/nutanix/ntnx-api-golang-clients/datapolicies-go-client/v4/...@v4.0.1
```
...
require (
	github.com/nutanix/ntnx-api-golang-clients/datapolicies-go-client/v4 latest
)
```
...
## Configuration
The Go client for Nutanix Data Policies APIs can be configured with the following parameters
...
extId := "BecDd2ff-eC89-cffa-DAE0-1C81AE19B1cd"
...
// 
response, err := ProtectionPoliciesApiInstance.ListProtectionPolicies(&page_, &limit_, &filter_, &orderby_, &select_)
if err != nil {
    ....
}
...
This library has a full set of [API Reference Documentation](https://developers.nutanix.com/sdk-reference?namespace=datapolicies&version=v4.0&language=go). This documentation is auto-generated, and the location may change.
