...
// This file holds the request struct for the ListConsistencyRulesByProtectionPolicyId operation.

type ListConsistencyRulesByProtectionPolicyIdRequest struct {
