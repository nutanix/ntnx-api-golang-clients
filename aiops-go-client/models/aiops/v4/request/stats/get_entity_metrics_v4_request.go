...
// This file holds the request struct for the GetEntityMetricsV4 operation.

type GetEntityMetricsV4Request struct {
	// (required) The UUID of a source.
	SourceExtId *string

	// (required) The UUID of an entity type.
	ExtId *string
