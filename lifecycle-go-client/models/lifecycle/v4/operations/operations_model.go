...
/*
REST response for all response codes in API path /lifecycle/v4.0/operations/$actions/compute-notifications Post operation
*/
...
/*
REST response for all response codes in API path /lifecycle/v4.0/operations/$actions/compute-recommendations Post operation
*/
...
/*
REST response for all response codes in API path /lifecycle/v4.0/operations/$actions/deploy-artifacts Post operation
*/
type DeployArtifactsApiResponse struct {
	ObjectType_ *string `json:"$objectType,omitempty"`
	...
	Data *OneOfDeployArtifactsApiResponseData `json:"data,omitempty"`

	Metadata *import3.ApiResponseMetadata `json:"metadata,omitempty"`
}

func NewDeployArtifactsApiResponse() *DeployArtifactsApiResponse {
	p := new(DeployArtifactsApiResponse)
	p.ObjectType_ = new(string)
	*p.ObjectType_ = "lifecycle.v4.operations.DeployArtifactsApiResponse"
	p.Reserved_ = map[string]interface{}{"$fv": "v4.r0"}
	p.UnknownFields_ = map[string]interface{}{}
...
func (p *DeployArtifactsApiResponse) GetData() interface{} {
	if nil == p.Data {
		return nil
	}
	return p.Data.GetValue()
...
func (p *DeployArtifactsApiResponse) SetData(v interface{}) error {
	if nil == p.Data {
		p.Data = NewOneOfDeployArtifactsApiResponseData()
	}
	e := p.Data.SetValue(v)
	if nil == e {
		if nil == p.DataItemDiscriminator_ {
...
/*
REST response for all response codes in API path /lifecycle/v4.0/operations/$actions/inventory Post operation
*/
...
/*
REST response for all response codes in API path /lifecycle/v4.0/operations/$actions/prechecks Post operation
*/
...
/*
REST response for all response codes in API path /lifecycle/v4.0/operations/$actions/preload-artifacts Post operation
*/
...
/*
REST response for all response codes in API path /lifecycle/v4.0/operations/$actions/upgrade Post operation
*/
...
type OneOfDeployArtifactsApiResponseData struct {
	Discriminator *string                `json:"-"`
	ObjectType_   *string                `json:"-"`
	oneOfType400  *import2.ErrorResponse `json:"-"`
	oneOfType2001 *import1.TaskReference `json:"-"`
...
func NewOneOfDeployArtifactsApiResponseData() *OneOfDeployArtifactsApiResponseData {
	p := new(OneOfDeployArtifactsApiResponseData)
	p.Discriminator = new(string)
	p.ObjectType_ = new(string)
	return p
}

func (p *OneOfDeployArtifactsApiResponseData) SetValue(v interface{}) error {
	if nil == p {
		return errors.New(fmt.Sprintf("OneOfDeployArtifactsApiResponseData is nil"))
	}
	switch v.(type) {
	case import2.ErrorResponse:
		if nil == p.oneOfType400 {
...
func (p *OneOfDeployArtifactsApiResponseData) GetValue() interface{} {
	if p.oneOfType400 != nil && *p.oneOfType400.ObjectType_ == *p.Discriminator {
		return *p.oneOfType400
	}
	if p.oneOfType2001 != nil && *p.oneOfType2001.ObjectType_ == *p.Discriminator {
...
func (p *OneOfDeployArtifactsApiResponseData) UnmarshalJSON(b []byte) error {
	vOneOfType400 := new(import2.ErrorResponse)
	if err := json.Unmarshal(b, vOneOfType400); err == nil {
		if "lifecycle.v4.error.ErrorResponse" == *vOneOfType400.ObjectType_ {
			if nil == p.oneOfType400 {
	...
	return errors.New(fmt.Sprintf("Unable to unmarshal for OneOfDeployArtifactsApiResponseData"))
}

func (p *OneOfDeployArtifactsApiResponseData) MarshalJSON() ([]byte, error) {
	if p.oneOfType400 != nil && *p.oneOfType400.ObjectType_ == *p.Discriminator {
		return json.Marshal(p.oneOfType400)
	}
	if p.oneOfType2001 != nil && *p.oneOfType2001.ObjectType_ == *p.Discriminator {
	...
	return nil, errors.New("No value to marshal for OneOfDeployArtifactsApiResponseData")
}
