...
// Create a subnet.
func (api *SubnetsApi) CreateSubnet(body *import2.Subnet, args ...map[string]interface{}) (*import2.TaskReferenceApiResponse, error) {
	argMap := make(map[string]interface{})
	if len(args) > 0 {
		argMap = args[0]
	}

	uri := "/api/networking/v4.2/config/subnets"
...
func (api *SubnetsApi) DeleteSubnetById(extId *string, args ...map[string]interface{}) (*import2.TaskReferenceApiResponse, error) {
	argMap := make(map[string]interface{})
	if len(args) > 0 {
		argMap = args[0]
	}

	uri := "/api/networking/v4.2/config/subnets/{extId}"
...
func (api *SubnetsApi) GetSubnetById(extId *string, args ...map[string]interface{}) (*import2.GetSubnetApiResponse, error) {
	argMap := make(map[string]interface{})
	if len(args) > 0 {
		argMap = args[0]
	}
	...
	unmarshalledResp := new(import2.GetSubnetApiResponse)
	json.Unmarshal(apiClientResponse.([]byte), &unmarshalledResp)
	return unmarshalledResp, err
}
...
func (api *SubnetsApi) ListSubnets(page_ *int, limit_ *int, filter_ *string, orderby_ *string, expand_ *string, select_ *string, args ...map[string]interface{}) (*import2.ListSubnetsApiResponse, error) {
	argMap := make(map[string]interface{})
	if len(args) > 0 {
		argMap = args[0]
	}
	...
	unmarshalledResp := new(import2.ListSubnetsApiResponse)
	json.Unmarshal(apiClientResponse.([]byte), &unmarshalledResp)
	return unmarshalledResp, err
}
...
func (api *SubnetsApi) ListVnicsBySubnetId(subnetExtId *string, page_ *int, limit_ *int, filter_ *string, orderby_ *string, select_ *string, args ...map[string]interface{}) (*import2.ListSubnetVnicsApiResponse, error) {
	...
	uri := "/api/networking/v4.2/config/subnets/{subnetExtId}/vnics"
	...
	unmarshalledResp := new(import2.ListSubnetVnicsApiResponse)
	json.Unmarshal(apiClientResponse.([]byte), &unmarshalledResp)
	return unmarshalledResp, err
}

// Update the specified subnet.
func (api *SubnetsApi) UpdateSubnetById(extId *string, body *import2.Subnet, args ...map[string]interface{}) (*import2.TaskReferenceApiResponse, error) {
	argMap := make(map[string]interface{})
	if len(args) > 0 {
		argMap = args[0]
	}
