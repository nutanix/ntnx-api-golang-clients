...
/**
  ...
  returns: (*networking.v4.stats.Layer2StretchStatsApiResponse, error)
*/
func (api *Layer2StretchStatsApi) GetLayer2StretchStats(extId *string, startTime_ *string, endTime_ *string, samplingInterval_ *int, statType_ *import2.DownSamplingOperator, select_ *string, args ...map[string]interface{}) (*import3.Layer2StretchStatsApiResponse, error) {
	argMap := make(map[string]interface{})
	if len(args) > 0 {
		argMap = args[0]
	}

	uri := "/api/networking/v4.0.a1/stats/layer2-stretches/{extId}"
