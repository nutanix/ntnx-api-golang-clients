...
func NewNetworkGatewayApi(apiClient *client.ApiClient) *NetworkGatewayApi {
	if apiClient == nil {
...
*/
func (api *NetworkGatewayApi) CreateNetworkGateway(body *import1.NetworkGateway, args ...map[string]interface{}) (*import1.TaskReferenceApiResponse, error) {
...
/**
  ...
  returns: (*networking.v4.config.TaskReferenceApiResponse, error)
*/
func (api *NetworkGatewayApi) DeleteNetworkGateway(extId *string, args ...map[string]interface{}) (*import1.TaskReferenceApiResponse, error) {
	argMap := make(map[string]interface{})
	if len(args) > 0 {
		argMap = args[0]
	}
...
*/
func (api *NetworkGatewayApi) GetNetworkGateway(extId *string, args ...map[string]interface{}) (*import1.NetworkGatewayApiResponse, error) {
	argMap := make(map[string]interface{})
	if len(args) > 0 {
		argMap = args[0]
	}
...
*/
func (api *NetworkGatewayApi) ListNetworkGateways(page_ *int, limit_ *int, filter_ *string, orderby_ *string, args ...map[string]interface{}) (*import1.NetworkGatewayListApiResponse, error) {
	argMap := make(map[string]interface{})
	if len(args) > 0 {
		argMap = args[0]
	}
...
/**
  ...
  returns: (*networking.v4.config.TaskReferenceApiResponse, error)
*/
func (api *NetworkGatewayApi) UpdateNetworkGateway(body *import1.NetworkGateway, extId *string, args ...map[string]interface{}) (*import1.TaskReferenceApiResponse, error) {
	argMap := make(map[string]interface{})
	if len(args) > 0 {
		argMap = args[0]
	}
...
/**
  ...
  returns: (*networking.v4.config.TaskReferenceApiResponse, error)
*/
func (api *NetworkGatewayApi) UpgradeNetworkGateway(extId *string, args ...map[string]interface{}) (*import1.TaskReferenceApiResponse, error) {
	argMap := make(map[string]interface{})
	if len(args) > 0 {
		argMap = args[0]
	}
