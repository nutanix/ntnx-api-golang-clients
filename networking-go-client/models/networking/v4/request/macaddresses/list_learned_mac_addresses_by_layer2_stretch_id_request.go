...
// This file holds the request struct for the ListLearnedMacAddressesByLayer2StretchId operation.

type ListLearnedMacAddressesByLayer2StretchIdRequest struct {
