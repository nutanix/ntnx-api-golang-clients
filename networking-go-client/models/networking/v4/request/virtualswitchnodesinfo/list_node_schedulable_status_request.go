package virtualswitchnodesinfo

// This file holds the request struct for the ListNodeSchedulableStatus operation.

type ListNodeSchedulableStatusRequest struct {
