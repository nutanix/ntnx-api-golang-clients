...
func (api *ApprovalPoliciesApi) AssociatePolicies(extId *string, body *[]import1.SecuredPolicy, args ...map[string]interface{}) (*import1.AssociatePoliciesApiResponse, error) {
	argMap := make(map[string]interface{})
	if len(args) > 0 {
		argMap = args[0]
	}

	uri := "/api/security/v4.0.b1/management/approval-policies/{extId}/$action/associate-policies"
...
func (api *ApprovalPoliciesApi) CreateApprovalPolicy(body *import1.ApprovalPolicy, args ...map[string]interface{}) (*import1.CreateApprovalPolicyApiResponse, error) {
	...
	uri := "/api/security/v4.0.b1/management/approval-policies"
...
func (api *ApprovalPoliciesApi) GetApprovalPolicyByExtId(extId *string, select_ *string, args ...map[string]interface{}) (*import1.GetApprovalPolicyApiResponse, error) {
	...
	uri := "/api/security/v4.0.b1/management/approval-policies/{extId}"
...
func (api *ApprovalPoliciesApi) ListApprovalPolicies(select_ *string, args ...map[string]interface{}) (*import1.ListApprovalPoliciesApiResponse, error) {
	argMap := make(map[string]interface{})
	if len(args) > 0 {
		argMap = args[0]
	}
