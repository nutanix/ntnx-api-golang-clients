...
func (api *VulnerabilitiesApi) ListVulnerabilities(page_ *int, limit_ *int, filter_ *string, orderby_ *string, select_ *string, args ...map[string]interface{}) (*import3.ListVulnerabilitiesApiResponse, error) {
	...
	unmarshalledResp := new(import3.ListVulnerabilitiesApiResponse)
