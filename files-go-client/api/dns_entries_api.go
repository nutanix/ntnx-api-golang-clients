...
type DnsEntriesApi struct {
  ApiClient *client.ApiClient
}

func NewDnsEntriesApi(apiClient *client.ApiClient) *DnsEntriesApi {
	if apiClient == nil {
...
/**
    ...
    parameters:-
    -> body (files.v4.config.Dns) (required) : Add DNS server entry.
    -> args (map[string]interface{}) (optional) : Additional Arguments

    returns: (*files.v4.config.AddDnsEntriesApiResponse, error)
*/
func (api *DnsEntriesApi) AddDnsServer(body *import1.Dns, args ...map[string]interface{}) (*import1.AddDnsEntriesApiResponse, error) {
    argMap := make(map[string]interface{})
	if len(args) > 0 {
        argMap = args[0]
    }

    uri := "/api/files/v4.0.a2/config/file-server/$actions/add-dns-entries"
    ...
    unmarshalledResp := new(import1.AddDnsEntriesApiResponse)
...
/**
    ...
    -> select_ (string) (optional) : A URL query parameter that allows clients to request a specific set of properties for each entity or complex type. Expression specified with the $select must conform to the OData V4.01 URL conventions. If a $select expression consists of a single select item that is an asterisk (i.e. *), then all properties on the matching resource will be returned. - extId - hostName - ipAddress - isVerified - links - tenantId 
    -> args (map[string]interface{}) (optional) : Additional Arguments

    returns: (*files.v4.config.DnsEntriesListApiResponse, error)
*/
func (api *DnsEntriesApi) GetDnsServers(page_ *int, limit_ *int, filter_ *string, orderby_ *string, select_ *string, args ...map[string]interface{}) (*import1.DnsEntriesListApiResponse, error) {
    argMap := make(map[string]interface{})
	if len(args) > 0 {
        argMap = args[0]
    }

    uri := "/api/files/v4.0.a2/config/file-server/dns-entries"
    ...
    unmarshalledResp := new(import1.DnsEntriesListApiResponse)
    json.Unmarshal(responseBody, &unmarshalledResp)
	return unmarshalledResp, err
}
...
/**
    ...
    parameters:-
    -> body (files.v4.config.Dns) (required) : Delete DNS server entry.
    -> args (map[string]interface{}) (optional) : Additional Arguments

    returns: (*files.v4.config.RemoveDnsEntriesApiResponse, error)
*/
func (api *DnsEntriesApi) RemoveDnsServer(body *import1.Dns, args ...map[string]interface{}) (*import1.RemoveDnsEntriesApiResponse, error) {
    argMap := make(map[string]interface{})
	if len(args) > 0 {
        argMap = args[0]
    }

    uri := "/api/files/v4.0.a2/config/file-server/$actions/remove-dns-entries"
    ...
    unmarshalledResp := new(import1.RemoveDnsEntriesApiResponse)
    json.Unmarshal(responseBody, &unmarshalledResp)
	return unmarshalledResp, err
}
...
/**
    ...
    parameters:-
    -> body (files.v4.config.Dns) (optional) : Verify DNS server entry.
    -> args (map[string]interface{}) (optional) : Additional Arguments

    returns: (*files.v4.config.VerifyDnsEntriesApiResponse, error)
*/
func (api *DnsEntriesApi) VerifyDnsServer(body *import1.Dns, args ...map[string]interface{}) (*import1.VerifyDnsEntriesApiResponse, error) {
    argMap := make(map[string]interface{})
	if len(args) > 0 {
        argMap = args[0]
    }

    uri := "/api/files/v4.0.a2/config/file-server/$actions/verify-dns-entries"
    ...
    unmarshalledResp := new(import1.VerifyDnsEntriesApiResponse)
    json.Unmarshal(responseBody, &unmarshalledResp)
	return unmarshalledResp, err
}
