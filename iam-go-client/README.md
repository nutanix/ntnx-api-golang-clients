...
```shell
$ go get github.com/nutanix/ntnx-api-golang-clients/iam-go-client/v4/...
```

##### Install a specific version

```shell
$ go get github.com/nutanix/ntnx-api-golang-clients/iam-go-client/v4/...@v4.1.2-beta.3
```
...
require (
	github.com/nutanix/ntnx-api-golang-clients/iam-go-client/v4 latest
)
```
...
extId := "16eFc6E1-fdbC-9dCd-A8c1-fa3ffaa33AC8"
...
var (
	ApiClientInstance *client.ApiClient
	DirectoryServicesApiInstance *api.DirectoryServicesApi
)
...
// Initialize the API
DirectoryServicesApiInstance = api.NewDirectoryServicesApi(ApiClientInstance)
page_ := 0
limit_ := 50
...
// 
response, err := DirectoryServicesApiInstance.ListDirectoryServices(&page_, &limit_, &filter_, &orderby_, &select_)
if err != nil {
    ....
}
...
This library has a full set of [API Reference Documentation](https://developers.nutanix.com/sdk-reference?namespace=iam&version=v4.1.b3&language=go). This documentation is auto-generated, and the location may change.
