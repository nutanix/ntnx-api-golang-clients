...
```shell
$ go get github.com/nutanix/ntnx-api-golang-clients/iam-go-client/v4/...@v4.0.1
```
...
extId := "63EaeFf2-d659-fe83-FC2A-FBCEA8Ee6Ecd"
...
// 
response, err := CertificateAuthenticationProvidersApiInstance.ListCertAuthProviders(&page_, &limit_, &filter_, &orderby_, &select_)
if err != nil {
    ....
}
...
This library has a full set of [API Reference Documentation](https://developers.nutanix.com/sdk-reference?namespace=iam&version=v4.0&language=go). This documentation is auto-generated, and the location may change.
