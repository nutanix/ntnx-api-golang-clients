# Go Client For Nutanix Nutanix Iam Versioned APIs
...
```shell
$ go get github.com/nutanix/ntnx-api-golang-clients/iam-go-client/v4/...@v4.0.1-alpha.1
```
...
require (
	github.com/nutanix/ntnx-api-golang-clients/iam-go-client/v4 v4.0.1-alpha.1
)
```
...
extId := "^dCDBAB9d-eeA8-9bFE-75Ab-b31a8bcdefd9$"
