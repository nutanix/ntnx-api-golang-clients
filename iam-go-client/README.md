...
```shell
$ go get github.com/nutanix/ntnx-api-golang-clients/iam-go-client/v4/...@v4.0.2-beta.1
```
...
require (
	github.com/nutanix/ntnx-api-golang-clients/iam-go-client/v4 v4.0.2-beta.1
)
```
...
extId := "C3bCf6cD-DE41-bD82-B0Bd-eAB9cada2f60"
...
This library has a full set of [API Reference Documentation](https://developers.nutanix.com/sdk-reference?namespace=iam&version=v4.0.b2&language=go). This documentation is auto-generated, and the location may change.
