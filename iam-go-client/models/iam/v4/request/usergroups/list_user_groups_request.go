...
// This file holds the request struct for the ListUserGroups operation.

type ListUserGroupsRequest struct {
	// The project UUID to scope the request. When provided, user groups are filtered to the specified project.
	XNtnxProject *string
