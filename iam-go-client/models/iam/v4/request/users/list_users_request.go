...
// This file holds the request struct for the ListUsers operation.

type ListUsersRequest struct {
	// The project UUID to scope the request. When provided, users are filtered to the specified project.
	XNtnxProject *string
