...
func (p *OneOfViewOperationApiResponseData) SetValue (v interface {}) error {
  ...
  switch v.(type) {
    case import3.ErrorResponse:
      ...
      *p.ObjectType_ = *p.oneOfType400.ObjectType_
    case Operation:
      if nil == p.oneOfType0 {p.oneOfType0 = new(Operation)}
...
func (p *OneOfCreateAccessPolicyApiResponseData) SetValue (v interface {}) error {
  ...
  switch v.(type) {
    case import2.Message:
      if nil == p.oneOfType0 {p.oneOfType0 = new(import2.Message)}
...
func (p *OneOfViewRoleApiResponseData) SetValue (v interface {}) error {
  ...
  if nil == v {
    if nil == p.oneOfType2 {p.oneOfType2 = new(interface {})}
    *p.oneOfType2 = nil
    if nil == p.Discriminator {p.Discriminator = new(string)}
    *p.Discriminator = "EMPTY"
    if nil == p.ObjectType_ {p.ObjectType_ = new(string)}
  ...
  switch v.(type) {
    case Role:
      if nil == p.oneOfType0 {p.oneOfType0 = new(Role)}
      *p.oneOfType0 = v.(Role)
      if nil == p.Discriminator {p.Discriminator = new(string)}
      *p.Discriminator = *p.oneOfType0.ObjectType_
      if nil == p.ObjectType_ {p.ObjectType_ = new(string)}
...
func (p *OneOfViewAccessPolicyApiResponseData) SetValue (v interface {}) error {
  ...
  switch v.(type) {
    case AccessPolicy:
      if nil == p.oneOfType0 {p.oneOfType0 = new(AccessPolicy)}
      *p.oneOfType0 = v.(AccessPolicy)
      if nil == p.Discriminator {p.Discriminator = new(string)}
      *p.Discriminator = *p.oneOfType0.ObjectType_
      if nil == p.ObjectType_ {p.ObjectType_ = new(string)}
