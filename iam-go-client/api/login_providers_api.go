...
func (api *LoginProvidersApi) ListLoginProviders(page_ *int, limit_ *int, filter_ *string, orderby_ *string, select_ *string, args ...map[string]interface{}) (*import3.ListLoginProvidersApiResponse, error) {
	...
	unmarshalledResp := new(import3.ListLoginProvidersApiResponse)
