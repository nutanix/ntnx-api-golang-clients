...
// This file holds the request struct for the ListValidationErrorsByRecoveryPlanJobId operation.

type ListValidationErrorsByRecoveryPlanJobIdRequest struct {
	// (required) The external identifier of the recovery plan job.
	RecoveryPlanJobExtId *string
