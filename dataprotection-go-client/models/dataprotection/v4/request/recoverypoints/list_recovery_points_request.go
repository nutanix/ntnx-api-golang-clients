...
// This file holds the request struct for the ListRecoveryPoints operation.

type ListRecoveryPointsRequest struct {
	// Cluster type from which recovery points must be fetched. Valid values: [AOS, MST]
	XClusterId *string

	// Recovery point store identifier for MST. This header is used to specify which recovery point store to query when
	// multiple recovery point stores are configured. Only applicable when X-Cluster-Id is set to MST.
	XRecoveryPointStoreId *string
