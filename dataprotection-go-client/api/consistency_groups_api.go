...
// Create a new consistency group with provided specification.
func (api *ConsistencyGroupsApi) CreateConsistencyGroup(body *import1.ConsistencyGroup, args ...map[string]interface{}) (*import1.CreateConsistencyGroupApiResponse, error) {
	...
	uri := "/api/dataprotection/v4.2/config/consistency-groups"
...
// Deletes a consistency group for the provided external identifier.
func (api *ConsistencyGroupsApi) DeleteConsistencyGroupById(extId *string, args ...map[string]interface{}) (*import1.DeleteConsistencyGroupApiResponse, error) {
	...
	uri := "/api/dataprotection/v4.2/config/consistency-groups/{extId}"
...
// Fetches the details of the consistency group for the provided external identifier.
...
// Lists the consistency groups defined on the system. List of consistency groups can be further filtered out using various filtering options.
...
// Updates the details of a consistency group for the provided external identifier.
